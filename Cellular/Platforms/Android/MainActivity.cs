...
namespace Cellular
{
    // ResizeableActivity and SingleTask are required by CommunityToolkit.Maui.MediaElement on Android
    // Previous: LaunchMode = LaunchMode.SingleTop, no ResizeableActivity
